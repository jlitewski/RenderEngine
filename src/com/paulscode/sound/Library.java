...
public class Library {
	...
	public Library() throws SoundSystemException {
		...
		this.listener = new ListenerData(0.0f, 0.0f, 0.0f, // position
		...
		this.streamingChannelSourceNames = new String[SoundSystemConfig
				.getNumberStreamingChannels()];
		this.normalChannelSourceNames = new String[SoundSystemConfig
	...
	protected boolean errorCheck(boolean error, String message) {
		if(error) {
			this.logger.err(getClassName(), message, 0);
			return true;
		}
		return false;
	}
