...
public class SoundSystemConfig {
	...
	/**
	 * Returns whether or not all sounds in each streaming source's queue will
	 * be handled as if they have exactly the same format once decoded
	 * (including channels, sample rate, and sample size). This is an advanced
	 * setting which should only be changed by experienced developers.
	 * 
	...
	public static synchronized void setCodec(String extension,
			Class<?> iCodecClass) throws SoundSystemException {
		if (extension == null)
	...
	private static void errorMessage(String message) {
		if (logger != null)
			logger.err("SoundSystemConfig", message, 0);
	}
	 ...
	 * 
	 * @param c
	 *            Class to call the method on.
	 * @param method
	 *            Name of the method.
	 * @param paramTypes
	 *            Data types of the parameters being passed to the method.
	 * @param params
	 *            Actual parameters to pass to the method.
	 * @return Specified method's return value, or null if error or void.
	 */
	private static Object runMethod(Class<?> c, String method,
