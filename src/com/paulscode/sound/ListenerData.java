 ...
 * SoundSystem's getListenerData() method. See {@link paulscode.sound.Vector3f
 * Vector3f} for more information about 3D coordinates and vectors. <br>
 * <br>
...
public class ListenerData {
	 ...
	 *            around the y-axis.
	 */
	public ListenerData(Vector3f p, Vector3f l, Vector3f u, float a) {
		position = new Vector3f(p);
		lookAt = new Vector3f(l);
		up = new Vector3f(u);
		velocity = new Vector3f(0.0f, 0.0f, 0.0f);
		angle = a;
	}
	 ...
	 *            around the y-axis.
	 */
	public void setData(Vector3f p, Vector3f l, Vector3f u, float a) {
		position.x = p.x;
		position.y = p.y;
		position.z = p.z;
		lookAt.x = l.x;
	 ...
	 */
	public void setOrientation(Vector3f l, Vector3f u) {
		lookAt.x = l.x;
		lookAt.y = l.y;
		lookAt.z = l.z;
		up.x = u.x;
