...
/**
 * The XMLNode class contains an XML tag's name, its parameters, and a handle to
 * the next XMLNode. <br>
 * <br>
 * <b><i> XMLNode License:</b></i><br>
 * <b><br>
...
public class XMLNode {
	...
	/**
	 * Prints out the name of this tag and all of its parameters and their
	 * values.
	 */
	 ...
	 * 
	 * @param tagContents
	 *            String containing everything between the XML brackets.
	 */
					...
					if (x + 1 >= splitTag.length) {
						...
						if (splitTag[x + 1].equals("=")) {
							...
							if (eq == null || eq.length < 1) {
								...
								parameters
										.put(splitTag[x].toUpperCase(), eq[1]);
								x = x + 2;
							}
						} else {
							warningMessage("Value not specified for "
	...
	protected static void warningMessage(String message) {
		logger.warn("XMLNode", "Warning in class 'XMLNode': " + message, 0);
	}
}
