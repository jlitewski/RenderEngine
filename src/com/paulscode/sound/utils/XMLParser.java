...
/**
 * The XMLParser class provides a somewhat limited interface for reading from
 * and processing XML files. <br>
 * <br>
 * <b><i> XMLParser License:</b></i><br>
 * <b><br>
...
public class XMLParser {
	...
	/**
	 * Returns a string containing the raw XML that was read and processed from
	 * the specified file. It longer has any newlines or leading and trailing
	 * spaces, and all words are seperated by single spaces.
	 * 
	 * @param xmlFile
	 *            URL to an XML file.
	 * @return Raw XML.
	 ...
	 * leading and trailing spaces, and all words are seperated by single
	 * spaces.
	 * 
	 * @param text
	 *            String to process.
	...
	protected static void errorMessage(String message) {
		logger.err("XMLParser", message, 0);
	}
}
